...
\name{Wonjae}{Choi}
\address{14, Sinchon-ro 7-gil, Seodaemun-gu, Seoul, Republic of Korea}
...
\quote{``Study and build"} % A quote or statement

\makecvfooter{\today}{Wonjae Choi~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
